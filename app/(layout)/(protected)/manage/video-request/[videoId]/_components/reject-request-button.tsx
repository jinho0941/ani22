...
import { rejectVideoRequest } from '@/app/action/video-request'

type Props = {
  requestId: string
}

export const RejectVideoRequestButton = ({ requestId }: Props) => {
  ...
  const onApprove = () => {
    startTransition(async () => {
      const action = await rejectVideoRequest({ requestId })
