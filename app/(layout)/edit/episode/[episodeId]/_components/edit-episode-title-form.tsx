...
export const EditEpisodeTitleForm = ({ episode }: Props) => {
  ...
  const isDisabled = currentValues === episode.title

  function onSubmit(values: z.infer<typeof formSchema>) {
    startTransition(async () => {
      const { title } = values
      const action = await updateEpisode({ episodeId: episode.id, title })
      if (!action.success) {
